...
- (void) testInitializationWithNilData
{
    ...
    XCTAssertNil(buffer, @"Creating buffer with nil data returns nil");
}
...
- (void) testBasicDurationCalculation
{
    ...
    XCTAssertNotNil(buffer, @"Create a sample buffer");
    XCTAssertEqual([buffer duration], (NSTimeInterval) 0.5,
